...
export default function Contact() {
  return (
    <>
      <section
        id="contact"
        className="flex flex-col md:flex-row h-screen bg-lightMode-background"
      >
        <div className="w-full md:w-1/2 h-1/2 md:h-screen my-4 drop-shadow-lg">
          <iframe
        ...
        <div className="w-full md:w-1/2 h-1/2 md:h-full flex items-center justify-center bg-lightMode-background p-0">
          <div className="w-full lg:w-1/2 text-wrap bg-lightMode-surface rounded-lg shadow-lg p-6">
