...
function HeadingText() {
  return (
    <div className="absolute top-1/2 md:top-2/3 left-1/2 md:left-2/3 transform -translate-x-1/2 -translate-y-1/2 p-4 md:p-8 rounded-xl z-10 max-w-xs md:max-w-lg text-center">
