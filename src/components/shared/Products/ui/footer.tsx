...
export default function ProductFooter() {
  return (
    <footer className="bg-lightMode-background text-lightMode-text dark:text-darkMode-text py-8 sm:py-12 dark:bg-darkMode-background">
      <div className="container mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
        ...
        <div className="grid gap-2">
          ...
          <nav className="grid gap-1">
            <Link
              href="mailto:info@sweethouse.com"
        ...
        <div className="grid gap-2">
          ...
          <div className="relative flex items-center">
            <InboxIcon className="absolute left-3 w-5 h-5 text-gray-400" />
            <input
              type="email"
              className="pl-10 pr-10 py-2 w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500 dark:bg-gray-700 dark:text-white dark:placeholder-white"
              placeholder="Email"
              required
            />
            <SendHorizontal className="absolute right-3 w-5 h-5 text-pink-500 cursor-pointer" />
          </div>
        </div>
      </div>
