        ...
        <div className="hidden md:flex justify-between gap-4 items-center">
          <div className="flex flex-row gap-11 mr-12 items-center">
            <Link href="/" className={navLinkStyle}>
              <BlurFadeText delay={BLUR_FADE_DELAY} text={`Naslovna`} />
            </Link>
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
            ...
            <Link href="/o-nama" className={navLinkStyle}>
              <BlurFadeText delay={BLUR_FADE_DELAY} text={`O Nama`} />
            </Link>
            <Link href="/faq" className={navLinkStyle}>
              <BlurFadeText delay={BLUR_FADE_DELAY} text={`FAQ`} />
            </Link>
            <Link href="/kontakt" className={navLinkStyle}>
              <BlurFadeText delay={BLUR_FADE_DELAY} text={`Kontakt`} />
            </Link>
            <BlurFade delay={BLUR_FADE_DELAY}>
              <ModeToggle />
            </BlurFade>
